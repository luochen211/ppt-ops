...
test("all shared contract schemas are valid JSON", async () => {
  for (const file of ["project.schema.json", "theme.schema.json", "assets.schema.json", "page-spec.schema.json", "audience-variants.schema.json", "corporate-template-profile.schema.json", "fact-ledger.schema.json"]) {
